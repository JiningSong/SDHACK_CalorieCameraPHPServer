...
<style>
    ...
    .bgimg {
        ...
        background-image: url("https://www.foodinsight.org/sites/default/files/The%20Myth%20of%20Negative%20Calorie%20Foods.jpg");
        min-height: 90%;
    }
</style>
<body>
...
<header class="bgimg w3-display-container w3-grayscale-min" id="home">
    ...
    <div class="w3-display-middle w3-center">
        ...
        <p><a href="{{ route("home") }}" class="w3-button w3-xxlarge w3-black">UPLOAD MY PHOTO</a></p>
    </div>
</header>
